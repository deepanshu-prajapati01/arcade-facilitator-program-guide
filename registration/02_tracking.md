...
2. **Submit Your URL on ArcadeCalc:**
   ...
   ![Add Public Profile to ArcadeCalc](../screenshots/register/arcadecalc-add-public-profile.png)
...
3. **Explore Your Profile Dashboard:**
   ...
   * Breakdown of bonus points per milestone.
   ...
   ![ArcadeCalc Profile Dashboard](../screenshots/register/arcadecalc-dashboard.png)
...
4. **Identify Incomplete Badges:**
   ...
   ![Incomplete Badges Section](../screenshots/register/arcadecalc-dashboard-incompletebadges.png)
